            ...
            <div className="container mx-auto px-4 max-w-5xl">
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h2 className="text-xl font-bold mb-3 text-gray-900">Sobre a Vaga</h2>
                ...
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h2 className="text-xl font-bold mb-3 text-gray-900">Vantagens</h2>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h2 className="text-xl font-bold mb-3 text-gray-900">Requisitos</h2>
                  <p className="text-gray-600 leading-relaxed">
            ...
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-2">O que faz um Afiliado de Marketing Digital na LG TecServ?</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Qual é a percentagem de comissão?</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Preciso morar em Maputo, Moçambique?</h3>
          ...
          <section className="container mx-auto px-4 py-8 relative z-10">
            <div className="bg-white rounded-2xl shadow-xl p-4 md:p-8 max-w-4xl mx-auto border border-gray-100">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Candidatar-se à Vaga</h2>
