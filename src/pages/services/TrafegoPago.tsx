...
const TrafegoPago = () => {
  ...
  return (
    <>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0">
          <OptimizedImage
            ...
            alt="Gestão de Tráfego Pago Profissional"
        ...
        <div className="relative container mx-auto px-4">
          <ScrollReveal className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
              Tráfego <span className="gradient-text">Pago Que Converte</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" asChild className="bg-gradient-primary shadow-primary">
                <a href="https://api.whatsapp.com/send?phone=258869824047&text=Ol%C3%A1%2C%20preciso%20de%20tr%C3%A1fego%20pago.%20Podem%20me%20dar%20mais%20informa%C3%A7%C3%B5es%3F" target="_blank" rel="noopener noreferrer">
                  Começar Campanha
      ...
      <RelatedLinks 
        currentPath="/servicos/gestao-trafego-pago-marketing-digital-mocambique"
      />
